...
public class CompositeJudgmentReferenceRemoverTest {
    ...
    public void removeReference() throws Exception {
        ...
        // execute
        compositeJudgmentReferenceRemover.removeReference(Lists.newArrayList(12L, 13L));
        
        // assert
        verify(judgmentReferenceRemover1).removeReference(Lists.newArrayList(12L, 13L));
        verify(judgmentReferenceRemover2).removeReference(Lists.newArrayList(12L, 13L));
    }
}
