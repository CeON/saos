...
/**
 * Maps enrichment tag service response message (
 * {@link EnrichmentTagUploadResponseMessages}) to {@link HttpStatus}
 * 
...
public class EnrichmentTagUploadMessageHttpStatusMapper {
     ...
     *             if no http status for the passed message could be found
     */
