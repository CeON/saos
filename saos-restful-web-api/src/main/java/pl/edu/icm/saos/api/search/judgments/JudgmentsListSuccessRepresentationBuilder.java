...
import pl.edu.icm.saos.api.search.judgments.views.SearchJudgmentsView.LawJournalEntryCodeTemplate;
...
public class JudgmentsListSuccessRepresentationBuilder {
    ...
    private Link buildLink(Pagination pagination,  JudgmentsParameters params, String relName, UriComponentsBuilder uriComponentsBuilder) {
        ...
        if(StringUtils.isNotBlank(params.getLawJournalEntryCode())) {
            uriComponentsBuilder.replaceQueryParam(LAW_JOURNAL_ENTRY_CODE, params.getLawJournalEntryCode());
        }
    ...
    private QueryTemplate toQueryTemplate(JudgmentsParameters params) {
        ...
        queryTemplate.setLawJournalEntryCode(new LawJournalEntryCodeTemplate(params.getLawJournalEntryCode()));
