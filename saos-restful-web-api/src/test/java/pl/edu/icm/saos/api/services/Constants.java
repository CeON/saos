...
public class Constants {
    ...
    public static final String SINGLE_DIVISIONS_PATH = "/api/ccDivisions";
    public static final String SINGLE_COURTS_PATH = "/api/commonCourts";
    public static final String DATE_FORMAT = "YYYY-MM-dd";


    public static final String DUMP_JUDGMENTS_PATH = "/api/dump/judgments";
    public static final String DUMP_COURTS_PATH = "/api/dump/commonCourts";
}
