...
public class FacetMonthYearValueConverterTest {

    
    private FacetMonthYearValueConverter converter = new FacetMonthYearValueConverter();
    ...
    public void handles_FALSE() {
        ...
        // given
        when(xdatePeriodChecker.isDateFacet(xsettings, PeriodUnit.MONTH)).thenReturn(false);
    ...
    public void handles_TRUE() {
        ...
        // given
        when(xdatePeriodChecker.isDateFacet(xsettings, PeriodUnit.MONTH)).thenReturn(true);
    ...
    public void convert() {
        ...
        // execute
        assertEquals(new MonthYear(12, 2010), converter.convert(value));
