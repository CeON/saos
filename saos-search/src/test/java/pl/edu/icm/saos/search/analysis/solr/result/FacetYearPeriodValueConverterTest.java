...
public class FacetYearPeriodValueConverterTest {

    
    private FacetYearPeriodValueConverter converter = new FacetYearPeriodValueConverter();
    ...
    public void handles_FALSE_MONTH() {
        ...
        // given
        XDateRange dateRange = new XDateRange(new LocalDate(2011, 10, 1), new LocalDate(2011, 12, 12), new Period(3, PeriodUnit.MONTH));
        when(xDateRangeUtils.getDateRange(xsettings)).thenReturn(dateRange);
    ...
    public void convert() {
        ...
        // given
        String value = "2010-01-01T00:00:00Z";
        ...
        LocalDate endDate = new LocalDate(2011, 12, 31);
        ...
        // execute
        assertEquals(new YearPeriod(2010, 2011), converter.convert(value, xsettings));
