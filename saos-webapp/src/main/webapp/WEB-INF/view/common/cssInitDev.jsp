...
<link type="text/css"  rel="stylesheet" href="${contextPath}/static/stylesheet/css/bootstrap.wcag.min.css"/>      
<link type="text/css"  rel="stylesheet" href="${contextPath}/static/stylesheet/css/daterangepicker-bs3.css"/>      
